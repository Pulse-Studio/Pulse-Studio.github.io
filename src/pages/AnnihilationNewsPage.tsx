...
export const AnnihilationNewsPage: FC = () => {
  ...
  return (
    <div className="annihilation-page min-h-screen bg-gradient-to-b from-black via-gray-900 to-black">
      <Helmet>
        <title>{t.news.title} - Annihilation</title>
        <meta name="description" content={t.news.title} />
      </Helmet>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          {currentVersion && (
            <div className="content-container bg-gray-900/90 border border-cyan-500/20 rounded-xl p-8 backdrop-blur-md shadow-2xl shadow-cyan-500/10">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-white mb-2">
                    {t.news.versionLabel} {currentVersion.version}
                  </h2>
              ...
              <HTMLViewer url={currentVersion.whatsnewUrl[language]} />
            </div>
          )}
        </div>
      </div>
